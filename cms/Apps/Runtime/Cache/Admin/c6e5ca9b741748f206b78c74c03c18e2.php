...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 新闻管理 <span class="c-gray en">&gt;</span>新闻咨询<span class="c-gray en">&gt;</span> 添加新闻咨询 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
                ...
                <tr>
                    ...
                    <td>
                        <div class="formControls">
                           ...
                           <label><input type="radio" name="istop" value="0" checked>正常</label>
                        </div>
                    </td>
                <tr>
  ...
  nowtimes=Date.parse(new Date())/1000;
        ...
        $("#form-category-add").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type:"post",
                    url:"/mprotect/cms/admin.php/News/news_add/type/save",
                    data: postData,//表单数据
                    success:function(d){
                        if(d===1){

...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 内容管理 <span class="c-gray en">&gt;</span>产品管理<span class="c-gray en">&gt;</span> 编辑产品 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr align="center">
                    ...
                    <td>
                        <div class="formControls">
                            <input type="text" class="input-text radius " value="<?php echo ($info[0][name]); ?>" placeholder="名称" autocomplete="off" name="name" id="name">
                        </div>
                    </td>
                    <td width="50px">副标题</td>
                    <td>
                        <div class="formControls">
                            <input type="text" class="input-text radius " value="<?php echo ($info[0][pname]); ?>" placeholder="副标题" autocomplete="off" name="pname" id="pname">
                        </div>
                    </td>
                </tr>
                <tr align="center">
                    ...
                    <td>
                        <div class="formControls">
                            <input type="text" class="input-text radius " value="<?php echo ($info[0][xx]); ?>" placeholder="香型" autocomplete="off" name="xx" id="xx">
                        </div>
                    </td>
                    <td width="50px">包装</td>
                    <td>
                        <div class="formControls">
                            <input type="text" class="input-text radius " value="<?php echo ($info[0][bz]); ?>" placeholder="包装" autocomplete="off" name="bz" id="bz">
                        </div>
                    </td>
                </tr>
                <tr align="center">
                    ...
                    <td>
                        <div class="formControls">
                            <input type="text" class="input-text radius " value="<?php echo ($info[0][jjd]); ?>" placeholder="酒精度" autocomplete="off" name="jjd" id="jjd">
                        </div>
                    </td>
                    <td width="50px">净含量</td>
                    <td>
                        <div class="formControls">
                            <input type="text" class="input-text radius " value="<?php echo ($info[0][jhl]); ?>" placeholder="净含量" autocomplete="off" name="jhl" id="jhl">
                        </div>
                    </td>
                </tr>
                <tr align="center">
                    ...
                    <td width="400px">
                        <div class="formControls">
                            <textarea id="content" name="content" style="height: 400px"><?php echo ($content); ?></textarea>
                        </div>
                    </td>
                    <td colspan="2" valign="bottom" class="td">
                        <div style="width: 100%"><img id='imgshow' style='width: 100%;height:100%;' <?php if($info[0][link] != '0'): ?>src='/mprotect/cms<?php echo ($info[0][link]); ?>'<?php endif; ?>/></div>
                        <span class="btnupload" <?php if($info[0][link] != '0'): ?>onmousedown="upload()"<?php endif; ?>>
                            <input type="button" name="file_0" id="uploadbtn" <?php if($info[0][link] != '0'): ?>value="重新上传" <?php else: ?>value="上传文件"<?php endif; ?>/>
                        </span>
                        <input type="hidden" name="beautyTown.img_0" id="img_url_0" value="" readonly="readonly"/>
                        <span id="delete_files" style="color: red;<?php if($info[0][link] == '0'): ?>display: none;<?php endif; ?>cursor: pointer;font-size: 18px;"><i title="删除" class="Hui-iconfont Hui-iconfont-del"></i></span>
                    ...
                    <td width="400px">
                        <div class="formControls">
                          ...
                          <select class="select" size="1" name="sort">
                              <option value="1" <?php if($info[0][sort] == 1): ?>selected<?php endif; ?>>1</option>
                              <?php $__FOR_START_26132__=2;$__FOR_END_26132__=11;for($i=$__FOR_START_26132__;$i < $__FOR_END_26132__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($info[0][sort] == $i): ?>selected<?php endif; ?>><?php echo ($i); ?></option><?php } ?>
                          </select>
                        </span>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="formControls">
                          ...
                          <select class="select" size="1" name="pid" id="pid">
                              ...
                              <?php if(is_array($Product)): $i = 0; $__LIST__ = $Product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo[id]); ?>" <?php if($info[0][pid] == $vo[id]): ?>selected<?php endif; ?>><?php echo ($vo[name]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
                        </span>
                        </div>
                    </td>
                ...
                <tr>
                    <td colspan="4" align="center" valign="center">
                        <input name="fileid" id="fileid" type="hidden" value="<?php echo ($info[0][fieldid]); ?>">
                        <input name="id" id="id" type="hidden" value="<?php echo ($info[0][id]); ?>">
    ...
    <script>
        ...
        $("#btnsubmit").click(function(){
            ...
            $.ajax({
                type:"post",
                url:"/mprotect/cms/admin.php/Product/indexedit/type/save",
                data: postData,//表单数据
                success:function(d){
                    layer.alert(d);
                    if(d===1){
        ...
        $("#delete_files").click(function(){
            if(confirm('确定要删除当前图片吗?')){
                ...
                $.ajax({
                    type: 'GET',
                    url : '/mprotect/cms/admin.php/Product/indexadd/type/delete/fileid/'+fileid,
                    async: true,

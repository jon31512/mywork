                ...
                <tr align="center">
                    ...
                    <td> <span class="select-box radius">
                          <select class="select" size="1" name="sort">
                              ...
                              <?php $__FOR_START_23168__=2;$__FOR_END_23168__=11;for($i=$__FOR_START_23168__;$i < $__FOR_END_23168__;$i+=1){ ?><option value="<?php echo ($i); ?>"><?php echo ($i); ?></option><?php } ?>
                          </select>
                        </span></td>
                </tr>
                <tr>
    ...
    <script>
        ...
        $("#form-category-add").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type:"post",
                    url:"/mprotect/cms/admin.php/Home/category_add/type/save",
                    data: postData,//表单数据
                    success:function(d){
                        if(d==='1'){

    ...
    <script>
        ...
        KindEditor.ready(function(K) {
            var editor = K.create('textarea[name="content"]', {
                ...
                uploadJson:'/mprotect/cms/admin.php/News/industry_add/type/upload/SSID/<?php echo session_id();?>/fileid/'+nowtimes,
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 新闻管理 <span class="c-gray en">&gt;</span>行业动态<span class="c-gray en">&gt;</span> 添加行业动态 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
    ...
    <script>
        $("#form-category-add").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type:"post",
                    url:"/mprotect/cms/admin.php/News/industry_add/type/save",
                    data: postData,//表单数据
                    success:function(d){
                        if(d===1){
        ...
        $('#close').on('click', function(){
            $.ajax({
                type:"get",
                url:"/mprotect/cms/admin.php/News/industry_add/type/fdelete/fileid/"+nowtimes,
                success:function(d){

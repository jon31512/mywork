...
<head lang="en">
    ...
    <!--编辑器组件-->
    <script type="text/javascript"  src="/mywork/cms/Public/kindeditor/kindeditor.js"></script>
    <script type="text/javascript"  src="/mywork/cms/Public/kindeditor/lang/zh_CN.js"></script>
    <title>编辑内容</title>
    <script>
        var nowtimes;
        ...
        KindEditor.ready(function(K) {
            var editor = K.create('textarea[name="content"]', {
                ...
                uploadJson:'/mywork/cms/admin.php/About/indexadd/type/upload/SSID/<?php echo session_id();?>/fileid/'+nowtimes,
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 内容管理 <span class="c-gray en">&gt;</span>关于我们<span class="c-gray en">&gt;</span> 编辑内容 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                ...
                <td>
                    <div class="formControls">
                        <input type="text" class="input-text radius " value="<?php echo ($info[0]["title"]); ?>" placeholder="标题" autocomplete="off" name="title" id="title">
                    </div>
                </td>
                <tr>
                <tr align="center">
                    ...
                    <td>
                        <div class="formControls">
                            <textarea id="editor" name="content" style="width:100%;height:500px;"><?php echo ($content); ?></textarea>
                        </div>
                    </td>
                <tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <div class="formControls">
                           <label><input type="radio" name="istop" value="1" <?php if($info[0][istop] == 1): ?>checked<?php endif; ?>>置顶</label>
                           <label><input type="radio" name="istop" value="0" <?php if($info[0][istop] == 0): ?>checked<?php endif; ?>>正常</label>
                        </div>
                    </td>
                <tr>
                    <td colspan="2" align="center" valign="center">
                        <input name="id" type="hidden" value="<?php echo ($info[0]["id"]); ?>">
    ...
    <script>
        $("#form-category-add").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type:"post",
                    url:"/mywork/cms/admin.php/About/indexedit/type/save",
                    data: postData,//表单数据
                    success:function(d){
                        if(d===1){
        ...
        $('#close').on('click', function(){
            $.ajax({
                type:"get",
                url:"/mywork/cms/admin.php/About/indexadd/type/fdelete/fileid/"+nowtimes,
                success:function(d){

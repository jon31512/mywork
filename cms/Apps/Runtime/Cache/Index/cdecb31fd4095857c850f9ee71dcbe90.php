...
<ul class="menu-2-ul">
    ...
    <span class="titleinfo"><span class="title-cn">行业动态</span><br><span class="title-en">INDUSTRY NEWS</span></span><span class="index"><img src="/mywork/cms/Public/img/index/news02.png" style="margin: 0;vertical-align:top;"> 首页 > 新闻中心 > 行业动态</span>
    <hr/>
    <div class="newstitle">
        <ul>
            <?php if(is_array($newslist)): $i = 0; $__LIST__ = $newslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="/mywork/cms/index.php/News/dex/industry/<?php echo ($vo["id"]); ?>.html"><?php echo ($vo["title"]); ?></a><span><?php echo time_string($vo[times],2);?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <div class="pages">

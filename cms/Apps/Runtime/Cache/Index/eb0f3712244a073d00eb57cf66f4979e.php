...
<head lang="en">
    ...
    <style>
        .menu-2-ul{list-style:none;position:relative;top: 200px;font-size: 16px;}
        ...
        hr{position: absolute;top: 70px;left: 320px;width: 800px;border:1px #595757 solid ;}
        .index{color: #595757;position: absolute;right: 320px;top: 50px;}
        .newstitle{color: #fff;position: absolute;left: 320px;top: 130px;font-size: 12px;height:550px;overflow-y: auto; width: 800px;}
        .c-c{margin-bottom: 15px;}
        .btn{margin: 0 auto;width: 370px;}
        .input{background-color: #000;color: #fff;height:35px;font-size: 14px;border: 1px #595757 solid;width: 370px;padding: 2px 0 0 10px;}
    </style>
...
<div data-options="region:'center',border:false" style="background-color: #000;">
    ...
    <span class="titleinfo"><span class="title-cn">在线加盟</span><br><span class="title-en">ONLINE FRANCHISE</span></span><span class="index"><img src="/mywork/cms/Public/img/index/news02.png" style="margin: 0;vertical-align:top;"> 首页 > 经销加盟 > 在线加盟</span>
    <hr/>
    <div class="newstitle">
        <div class="c-c">
            <img src="/mywork/cms/Public/img/index/name.png" style="vertical-align: middle;margin-right: 15px;">
            <input class="input" placeholder="您的姓名"></div>
        <div class="c-c">
            <img src="/mywork/cms/Public/img/index/jiontll.png" style="vertical-align: middle;margin-right: 15px;">
            <input class="input" placeholder="您的联系电话"></div>
        <div class="c-c">
            <img src="/mywork/cms/Public/img/index/joinliuyan.png" style="vertical-align: top;margin-right: 15px;">
            <textarea class="input" placeholder="请留下您要说的话" style="height: 155px;width: 360px;padding: 10px;"></textarea></div>
        <div class="btn">
           <img src="/mywork/cms/Public/img/index/joinbtn.png" style="border: 0;cursor: pointer;">
        </div>
    </div>
